...
Jeweler::Tasks.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "Rakefile", "lib/feedme.rb", "lib/truncator.rb", "lib/util.rb", "examples/rocketboom.rb", "examples/rocketboom.rss", "test/test_helper.rb"]
